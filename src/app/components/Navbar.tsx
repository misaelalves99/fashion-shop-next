      ...
      <div className="w-full bg-cyan-600">
        <div className="max-w-7xl mx-auto flex items-center justify-end gap-6 px-6 py-3 md:px-10">
          <button
            ...
            className="text-white text-3xl hover:text-cyan-300 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-300 rounded"
          >
            <MdDarkMode />
          </button>
          ...
          <Link href="/cart" className="relative text-white hover:text-cyan-300 transition-colors duration-300">
